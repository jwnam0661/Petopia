/* A2MEMBER에 좌표 칼럼 추가 */
ALTER TABLE a2member
		    	ADD(lat varchar2(30)
		   		, lng varchar2(30)
		  		, bound_northeast_lat varchar2(30)
		  		, bound_northeast_lng varchar2(30)
		  		, bound_southwest_lat varchar2(30)
		  		, bound_southwest_lng varchar2(30));
		  		
/* a2message에 read 칼럼 추가 */
ALTER TABLE a2message
				ADD(READ varchar2(30));

/* 영상통화를 위한 테이블 생성*/
CREATE TABLE a2videochat(
			  sittingNo number not null
			, status varchar2(50) not null
			, endStatus varchar2(50) not null
			);
			
INSERT INTO a2videochat VALUES(21, 'nocreated', '1')
...
DROP SEQUENCE SEQ_A2TRANSACTION_TransNo;
...
DROP SEQUENCE SEQ_Transaction_TransactionNo;
...
CREATE SEQUENCE SEQ_A2TRANSACTION_TransNo INCREMENT BY 1 START WITH 1;
...
(
	...
	-- Vaccine1
	Vaccine1 varchar2(30),
	-- Vaccine2
	Vaccine2 varchar2(30),
	-- Vaccine3
	Vaccine3 varchar2(30),
	-- Vaccine4
	Vaccine4 varchar2(30),
	-- 코멘트
...
alter table a2sitter modify(AvailableSize varchar2(30));
-- 시터정보
...
(
	...
	-- 시팅 가능 수
	AvailableNumber number NOT NULL,
	-- 가능크기 : 시팅가능한 최대 크기
	AvailableSize varchar2(30) NOT NULL,
	-- 거주지 정보
...
COMMENT ON COLUMN A2PHOTO.MemberNo IS '회원번호';
...
COMMENT ON COLUMN A2SITTING.MemberNo IS '회원번호';
...
select memberNo from A2MEMBER;
select address1, address2 from a2member where memberNo = 46;
update A2MEMBER set lat='37.4962', lng='127.0369' where memberNo = 46;